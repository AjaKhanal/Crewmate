                                ...
                                transformationMenu.addItemListener(new ItemListener() {
                                    public void itemStateChanged(final ItemEvent e) {
                                        if (Boolean.parseBoolean(properties.getProperty("Transformation", "true"))) {
                                            transformationMenu.setState(false);
                                            properties.setProperty("Transformation", "false");
                                        } else {
                                            transformationMenu.setState(true);
                                ...
                                multiscreenMenu.addItemListener(new ItemListener() {
                                    public void itemStateChanged(final ItemEvent e) {
                                        if (Boolean.parseBoolean(properties.getProperty("Multiscreen", "true"))) {
                                            multiscreenMenu.setState(false);
                                            properties.setProperty("Multiscreen", "false");
                                        } else {
                                            multiscreenMenu.setState(true);
                        ...
                        btnSettings.addActionListener(new ActionListener() {
                            public void actionPerformed(final ActionEvent e) {
                                ...
                                shimejiChooserMenu.addItemListener(new ItemListener() {
                                    public void itemStateChanged(final ItemEvent e) {
                                        if (Boolean.parseBoolean(properties.getProperty("AlwaysShowShimejiChooser", "false"))) {
                                            ...
                                            shimejiChooserMenu.setState(true);
                                ...
                                filterMenu.addActionListener(new ActionListener() {
                                    public void actionPerformed(final ActionEvent e) {
                                        form.dispose();
                                        if (Boolean.parseBoolean(properties.getProperty("Filter", "false"))) {
                                            filterMenu.setState(false);
                                            properties.setProperty("Filter", "false");
                                        } else {
                                            filterMenu.setState(true);
                        ...
                        btnLanguage.addActionListener(new ActionListener() {
                            public void actionPerformed(final ActionEvent e) {
                                ...
                                japaneseMenu.addActionListener(new ActionListener() {
                                    public void actionPerformed(final ActionEvent e) {
                                        form.dispose();
                                        if (!properties.getProperty("Language", "en-GB").equals("ja-JP")) {
                                            properties.setProperty("Language", "ja-JP");
                                            refreshLanguage();
                                        }
                                        try {
                                            FileOutputStream output = new FileOutputStream("./conf/settings.properties");
